...
{
    [AddComponentMenu("UI/UIColor/Three Gradient Color"), RequireComponent(typeof(Graphic))]
    public class ThreeGradientColor : BaseMeshEffect
    {
