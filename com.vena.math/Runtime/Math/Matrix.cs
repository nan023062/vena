...
namespace Vena.Math
{
    public struct Matrix : IEquatable<Matrix>
    {
        ...
        public static Matrix RTS(Vector3 position, Quaternion quaternion)
        {
        ...
        public override int GetHashCode()
        {
            return (((((
                         ((((((((((this.M11.GetHashCode() + this.M12.GetHashCode()) + this.M13.GetHashCode()) +
                          ...
                          this.M33.GetHashCode()) + this.M34.GetHashCode()) + this.M41.GetHashCode()) +
                     this.M42.GetHashCode()) +
                     this.M43.GetHashCode()) + this.M44.GetHashCode());
        }
