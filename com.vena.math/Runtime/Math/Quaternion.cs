...
namespace Vena.Math
{
    public struct Quaternion : IEquatable<Quaternion>
    {
        ...
        public static Quaternion Divide(Quaternion quaternion1, Quaternion quaternion2)
        {
            ...
            float num14 =
                (((quaternion2.X * quaternion2.X) + (quaternion2.Y * quaternion2.Y)) +
        ...
        public static Vector3 operator *(Quaternion lhs , Vector3 rhs)
        {
            ...
            vector.X = (((1f - (num5 + num6)) * rhs.X) + ((num7 - num12) * rhs.Y)) + ((num8 + num11) * rhs.Z);
            vector.Y = (((num7 + num12) * rhs.X) + ((1f - (num4 + num6)) * rhs.Y)) + ((num9 - num10) * rhs.Z);
            vector.Z = (((num8 - num11) * rhs.X) + ((num9 + num10) * rhs.Y)) + ((1f - (num4 + num5)) * rhs.Z);
            return vector;
        }
        ...
        public static Quaternion Slerp(Quaternion quaternion1, Quaternion quaternion2, float amount)
        {
            ...
            else
            {
                ...
                num2 = flag
                    ? (((float)-System.Math.Sin((double)(num * num5))) * num6)
                    : (((float)System.Math.Sin((double)(num * num5))) * num6);
            }
