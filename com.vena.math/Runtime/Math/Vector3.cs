// -----------------------------------------------------------------------------
// Vena Math
// Math types and utilities for the Vena open-source Unity framework.
// Copyright (c) Nan Li.
...
namespace Vena.Math
{
    public struct Vector3 : IEquatable<Vector3>
    {
        ...
        public static float Distance(in Vector3 vector1, in Vector3 vector2)
        {
            float result;
        ...
        {
            float result;
            DistanceSquared(this, zero, out result);
            return (float)System.Math.Sqrt(result);
        }
        ...
        public static void Transform(Vector3[] sourceArray, ref Matrix matrix, Vector3[] destinationArray)
        {
            if (destinationArray.Length < sourceArray.Length)
                throw new ArgumentOutOfRangeException("The destination array is smaller than the source array.");
        ...
        {
            return value1.X.AlmostEqual(value2.X) 
                   && value1.Y.AlmostEqual(value2.Y)
                   && value1.Z.AlmostEqual(value2.Z);
        }
