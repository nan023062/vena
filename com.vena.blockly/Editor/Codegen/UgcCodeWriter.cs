...
namespace Vena.Blockly.Editor
{
    ...
    {
        private const string AutoGeneratedHeader = "// <auto-generated by Blockly UGC codegen; do not edit manually>";
        ...
        private static IReadOnlyList<SlotInfo> BuildSlotList(ScannedMember m)
        {
            ...
            // 1) instance（若需）
            // 2) 参数（method 走 UgcMethod.parameterNames 顺序；property setter 走单 value 槽）
        ...
        /// 当前 codegen 输入面（UgcMethod / UgcProperty 参数）只有非 ref 普通类型，足够。
        /// </summary>
