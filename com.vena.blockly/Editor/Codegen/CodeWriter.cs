...
namespace Vena.Blockly.Editor
{
    ...
    internal static class CodeWriter
    {
        ...
        private static string EmitBehaviorSourceFile(ScannedSource src)
        {
            ...
            AppendBehaviorSource(sb, src, indent: "    ");

            sb.Append("}").Append(NL);
            return sb.ToString();
        }

        private static void AppendBehaviorSource(StringBuilder sb, ScannedSource src, string indent)
        {
            var implType = src.SourceType;
            var implName = TypeRef(implType);
            var srcName = BehaviorSourceName(implType);
            var menuPath = src.MenuPath;

            // 镜像字段按 Order 升序（IR / UI / Init 三者一致）。
            var slots = src.ImplSlots.OrderBy(s => s.Order).ToList();

            sb.Append(indent).Append("[BlocklySource(\"").Append(EscapeStringLiteral(menuPath))
                .Append("\", typeof(").Append(srcName).Append(".Node))]").Append(NL);
            sb.Append(indent).Append("public sealed class ").Append(srcName)
                .Append(" : BehaviorNodeSource<").Append(implName).Append(">").Append(NL);
            sb.Append(indent).Append("{").Append(NL);
            ...
            AppendBehaviorNode(sb, srcName, implName, slots, indent + "    ");

            sb.Append(indent).Append("}").Append(NL);
        }

        private static void AppendBehaviorNode(StringBuilder sb, string srcName, string implName, IReadOnlyList<ImplSlotInfo> slots, string indent)
        {
            sb.Append(indent).Append("sealed class Node : BehaviorNode<").Append(srcName).Append(", ").Append(implName).Append(">").Append(NL);
            sb.Append(indent).Append("{").Append(NL);
            ...
            {
                sb.Append(indent).Append("        _").Append(slot.FieldName)
                    .Append(" = blockly.CreateBlockly(source.").Append(slot.FieldName).Append(");").Append(NL);
            }
            sb.Append(indent).Append("    }").Append(NL);
            sb.Append(NL);

            sb.Append(indent).Append("    protected override void InitializeProperties(").Append(implName).Append(" impl)").Append(NL);
            sb.Append(indent).Append("    {").Append(NL);
            foreach (var slot in slots)
            {
                sb.Append(indent).Append("        impl.").Append(slot.FieldName)
                    .Append(" = _").Append(slot.FieldName).Append(".Call<").Append(TypeRef(slot.FieldValueType)).Append(">();").Append(NL);
            }
            sb.Append(indent).Append("    }").Append(NL);
            sb.Append(NL);

            sb.Append(indent).Append("    protected override void CleanProperties(").Append(implName).Append(" impl)").Append(NL);
            sb.Append(indent).Append("    {").Append(NL);
            foreach (var slot in slots)
            {
                if (slot.FieldValueType.IsValueType) continue;
                sb.Append(indent).Append("        impl.").Append(slot.FieldName).Append(" = null;").Append(NL);
            }
            sb.Append(indent).Append("    }").Append(NL);
            sb.Append(NL);

            sb.Append(indent).Append("    protected override void OnBeforeDestroy()").Append(NL);
            sb.Append(indent).Append("    {").Append(NL);
            foreach (var slot in slots)
            {
                sb.Append(indent).Append("        blockly.DestroyBlockly(_").Append(slot.FieldName).Append(");").Append(NL);
                sb.Append(indent).Append("        _").Append(slot.FieldName).Append(" = null;").Append(NL);
            }
            sb.Append(indent).Append("    }").Append(NL);
        ...
        private static string BehaviorSourceName(Type implType)
        {
            ...
            return simpleName + "Source";
        }

        private static void AppendBehaviorNodeMetadataCtor(StringBuilder sb, ScannedSource src, string indent)
        {
            var implType = src.SourceType;
            var ns = implType.Namespace;
            var generatedNs = string.IsNullOrEmpty(ns) ? "Generated" : ns + ".Generated";
            var srcName = BehaviorSourceName(implType);
            var srcFqn = generatedNs + "." + srcName;
            var slots = src.ImplSlots.OrderBy(s => s.Order).ToList();
            ...
            sb.Append(indent).Append("    sourceType: typeof(").Append(srcFqn).Append("),").Append(NL);
            sb.Append(indent).Append("    nodeType: typeof(").Append(srcFqn).Append(".Node),").Append(NL);
            sb.Append(indent).Append("    menuPath: \"").Append(EscapeStringLiteral(src.MenuPath)).Append("\",").Append(NL);
            sb.Append(indent).Append("    properties: new NodePropertyMetadata[]").Append(NL);
            sb.Append(indent).Append("    {").Append(NL);
            foreach (var slot in slots)
            {
        ...
        private static string EmitTimelineSourceFile(ScannedSource src)
        {
            ...
            AppendTimelineSource(sb, src, indent: "    ");

            sb.Append("}").Append(NL);
            return sb.ToString();
        }

        private static void AppendTimelineSource(StringBuilder sb, ScannedSource src, string indent)
        {
            var implType = src.SourceType;
            var implName = TypeRef(implType);
            var srcName = TimelineSourceName(implType);
            var menuPath = src.MenuPath;
            ...
            sb.Append(indent).Append("[BlocklySource(\"").Append(EscapeStringLiteral(menuPath))
                .Append("\", typeof(").Append(srcName).Append(".Node))]").Append(NL);
            sb.Append(indent).Append("public sealed class ").Append(srcName)
                .Append(" : ClipSource<").Append(implName).Append(">").Append(NL);
            sb.Append(indent).Append("{").Append(NL);
            ...
            AppendTimelineNode(sb, srcName, implName, slots, indent + "    ");

            sb.Append(indent).Append("}").Append(NL);
        }

        private static void AppendTimelineNode(StringBuilder sb, string srcName, string implName, IReadOnlyList<ImplSlotInfo> slots, string indent)
        {
            sb.Append(indent).Append("sealed class Node : Clip<").Append(srcName).Append(", ").Append(implName).Append(">").Append(NL);
            sb.Append(indent).Append("{").Append(NL);
            ...
            {
                sb.Append(indent).Append("        _").Append(slot.FieldName)
                    .Append(" = timeline.blockly.CreateBlockly(source.").Append(slot.FieldName).Append(");").Append(NL);
            }
            sb.Append(indent).Append("    }").Append(NL);
            sb.Append(NL);
            ...
            foreach (var slot in slots)
            {
                sb.Append(indent).Append("        timeline.blockly.DestroyBlockly(_").Append(slot.FieldName).Append(");").Append(NL);
                sb.Append(indent).Append("        _").Append(slot.FieldName).Append(" = null;").Append(NL);
            }
            sb.Append(indent).Append("    }").Append(NL);
        ...
        private static void AppendTimelineNodeMetadataCtor(StringBuilder sb, ScannedSource src, string indent)
        {
            var implType = src.SourceType;
            var ns = implType.Namespace;
            var generatedNs = string.IsNullOrEmpty(ns) ? "Generated" : ns + ".Generated";
